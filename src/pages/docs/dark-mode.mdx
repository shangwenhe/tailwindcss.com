...
If you've set <a href="/tailwind/docs/configuration#prefix">a prefix</a> in your Tailwind config, be sure to add that to the `dark` class. For example, if you have a prefix of `tw-`, you'll need to use the `tw-dark` class to enable dark mode.
